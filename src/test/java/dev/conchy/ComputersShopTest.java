...
//         // Test if computers are added correctly
//         assertThat(shop.getComputers(), hasSize(0));
//         assertThat(shop.getComputers(), hasItems(computer1, computer2));

//         // Test if any computer in the list has brand "HP"
//         assertThat(shop.getComputers(), hasItem(hasProperty("brand", is("HP"))));
//     }
